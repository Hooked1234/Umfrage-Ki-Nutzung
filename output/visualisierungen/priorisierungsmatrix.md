...
quadrantChart
    ...
    y-axis "Niedriger Nutzen" --> "Hoher Nutzen"
    quadrant-1 "Strategisch (planen)"
    quadrant-2 "Quick Wins (sofort starten)"
    quadrant-3 "Füllthemen (optional)"
    quadrant-4 "Aufwändig (abwägen)"
    "Texte überarbeiten": [0.20, 0.85]
    "Zusammenfassen": [0.18, 0.88]
    "Übersetzungen": [0.25, 0.80]
    "Ideen sammeln": [0.22, 0.70]
    "E-Mail-Vorlagen": [0.30, 0.65]
    "Recherche": [0.35, 0.78]
